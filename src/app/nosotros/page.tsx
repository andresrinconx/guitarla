...
export default function Nosotros() {
  return (
    <div>
      <h1 className='text-2xl font-extrabold text-[#d88506] text-center my-10'>Nosotros</h1>
      <div className='mb-8 flex flex-col mx-10 md:mx-40 md:flex-row md:items-center'>
